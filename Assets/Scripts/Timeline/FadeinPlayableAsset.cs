...
public class FadeinPlayableAsset : PlayableAsset
{
    ...
    public FadeinBehaviour fadeinBehaviour;
    
    public override Playable CreatePlayable(PlayableGraph graph, GameObject owner)
    {
        var playable = ScriptPlayable<FadeinBehaviour>.Create(graph, fadeinBehaviour);
...
public class FadeinBehaviour : PlayableBehaviour
{
    ...
    public override void PrepareFrame(Playable playable, FrameData info)
    {
        ...
        targetImage.color = new Color(targetImage.color.r, targetImage.color.g, targetImage.color.b, progress);
    }
}